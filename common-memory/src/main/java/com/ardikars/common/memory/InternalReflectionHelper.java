...
//
//final class InternalReflectionHelper {
//
...
//     * @throws UnsupportedOperationException maybe {@link InternalReflectionHelper#setAccessible(AccessibleObject, boolean)} disabled.
//     */
//    public static Throwable trySetAccessible(final AccessibleObject object, final boolean checkAccessible) throws UnsupportedOperationException {
//        if (checkAccessible && !ACCESS_CONTROL) {
//            return new UnsupportedOperationException("InternalReflectionHelper.setAccessible(true) disabled");
//        }
...
//     * @param checkAccessible accessible.
//     * @return returns null on success, throwable otherwise.
//     * @deprecated please use {@link InternalReflectionHelper}.{@link #trySetAccessible(AccessibleObject, boolean)}
//     */
...
//     * @throws IllegalArgumentException cls should be not null.
//     */
...
//     * @throws IllegalArgumentException cls should be not null.
//     */
//    public static List<Class<?>> getAllClasses(final Class<?> cls) throws IllegalArgumentException {
//        if (cls == null) {
//            throw new IllegalArgumentException("Class should be not null");
//        }
//        final List<Class<?>> classes = new ArrayList<Class<?>>();
...
//     * @throws IllegalArgumentException cls should be not null.
//     */
//    public static List<Class<?>> getAllInterfaces(final Class<?> cls) throws IllegalArgumentException {
//        if (cls == null) {
//            throw new IllegalArgumentException("Class should be not null");
//        }
...
//     * @throws IllegalArgumentException cls should be not null.
//     */
//    public static List<Class<?>> getAllClassesAndInterfaces(final Class<?> cls) throws IllegalArgumentException {
//        if (cls == null) {
//            throw new IllegalArgumentException("Class should be not null");
//        }
...
//     * @throws IllegalArgumentException cls should be not null.
//     */
//    public static List<Class<?>> getAllSuperClassesAndInterfaces(final Class<?> cls) throws IllegalArgumentException {
//        if (cls == null) {
//            throw new IllegalArgumentException("Class should be not null");
//        }
...
//
//    static {
//        ACCESS_CONTROL = InternalPropertyHelper.getBoolean("common.util.tryReflectionSetAccessible", InternalPlatformHelper.getJavaMojorVersion() < 9);
//    }
//
//}
