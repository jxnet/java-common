...
public final class ByteBuffers {
     ...
     */
    public static void freeDirectBuffer(ByteBuffer buffer, Callback<Void> callback) {
     ...
     */
    private static Object findBufferAddressField(sun.misc.Unsafe unsafe) {
    ...
    static {
        ...
        if (unsafe != null) {
            Object maybeBufferAddressField = findBufferAddressField(unsafe);
